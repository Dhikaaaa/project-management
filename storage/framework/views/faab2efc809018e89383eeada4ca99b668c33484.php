                        ...
                        <div class="card-body">
                             <div class="d-flex align-items-center">
                                 ...
                                 <div class="flex-grow-1 ms-3">
                                    <p class="text-uppercase fw-semibold fs-13 text-muted mb-1">Total Invested</p>
                    ...
                    <div class="card">
                        <div class="card-body">
                             <div class="d-flex align-items-center">
                                 ...
                                 <div class="flex-grow-1 ms-3">
                                    <p class="text-uppercase fw-semibold fs-13 text-muted mb-1">Total Change</p>
                    ...
                    <div class="card">
                        <div class="card-body">
                             <div class="d-flex align-items-center">
                                 ...
                                 <div class="flex-grow-1 ms-3">
                                    <p class="text-uppercase fw-semibold fs-13 text-muted mb-1">Day Change</p>
                                ...
                                <div class="row align-items-center">
                                    <div class="col-6">
                                        <div class="d-flex flex-wrap gap-4 align-items-center">
                                            ...
                                            <p class="fw-medium text-muted mb-0">$75.69 <span class="text-success fs-13 ms-1">+1.99%</span></p>
                        ...
                        <table class="table table-hover table-borderless table-centered align-middle table-nowrap mb-0">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>$48,568.025</td>
                                    <td><h6 class="text-success mb-0"><i class="mdi mdi-trending-up align-middle me-1"></i>5.26</h6></td>
                                    <td>$53,914.025</td>
                                    <td>1.25634801</td>
                                ...
                                <tr>
                                    ...
                                    <td>$87,142.027</td>
                                    <td><h6 class="text-danger mb-0"><i class="mdi mdi-trending-down align-middle me-1"></i>3.07</h6></td>
                                    <td>$75,854.127</td>
                                    <td>2.85472161</td>
                                    <td><a href="apps-crypto-buy-sell" class="btn btn-sm btn-soft-secondary">Trade</a></td>
                                </tr><!-- end -->
                                <tr>
                                    ...
                                    <td>$33,847.961</td>
                                    <td><h6 class="text-success mb-0"><i class="mdi mdi-trending-up align-middle me-1"></i>7.13</h6></td>
                                    <td>$44,152.185</td>
                                    <td>1.45612347</td>
                                    <td><a href="apps-crypto-buy-sell" class="btn btn-sm btn-soft-secondary">Trade</a></td>
                                </tr><!-- end -->
                                <tr>
                                    ...
                                    <td>$73,654.421</td>
                                    <td><h6 class="text-success mb-0"><i class="mdi mdi-trending-up align-middle me-1"></i>0.97</h6></td>
                                    <td>$48,367.125</td>
                                    <td>0.35734601</td>
                                    <td><a href="apps-crypto-buy-sell" class="btn btn-sm btn-soft-secondary">Trade</a></td>
                                </tr><!-- end -->
                                <tr>
                                    ...
                                    <td>$66,742.077</td>
                                    <td><h6 class="text-danger mb-0"><i class="mdi mdi-trending-down align-middle me-1"></i>1.08</h6></td>
                                    <td>$53,487.083</td>
                                    <td>3.62912570</td>
                                    <td><a href="apps-crypto-buy-sell" class="btn btn-sm btn-soft-secondary">Trade</a></td>
                                </tr><!-- end -->
                                <tr>
                                    ...
                                    <td>$34,736.209</td>
                                    <td><h6 class="text-success mb-0"><i class="mdi mdi-trending-up align-middle me-1"></i>4.52</h6></td>
                                    <td>$15,203.347</td>
                                    <td>1.85412740</td>
                                    <td><a href="apps-crypto-buy-sell" class="btn btn-sm btn-soft-secondary">Trade</a></td>
                                </tr><!-- end -->
                                <tr>
                                    ...
                                    <td>$56,357.313</td>
                                    <td><h6 class="text-danger mb-0"><i class="mdi mdi-trending-down align-middle me-1"></i>2.87</h6></td>
                                    <td>$61,843.173</td>
                                    <td>1.87732061</td>
                                    <td><a href="apps-crypto-buy-sell" class="btn btn-sm btn-soft-secondary">Trade</a></td>
                                </tr><!-- end -->
                                <tr>
                                    ...
                                    <td>$62,357.649</td>
                                    <td><h6 class="text-success mb-0"><i class="mdi mdi-trending-up align-middle me-1"></i>3.45</h6></td>
                                    <td>$54,843.173</td>
                                    <td>0.95632087</td>
                                    <td><a href="apps-crypto-buy-sell" class="btn btn-sm btn-soft-secondary">Trade</a></td>
                                </tr><!-- end -->
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Application\Template\laravel_velzon-main\resources\views/dashboard-crypto.blade.php ENDPATH**/ ?>