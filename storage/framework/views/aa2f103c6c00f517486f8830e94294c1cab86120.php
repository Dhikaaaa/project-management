        ...
        <div class="tasks-list">
            <div class="d-flex mb-3">
                <div class="flex-grow-1">
                   <h6 class="fs-14 text-uppercase fw-semibold mb-0">Unassigned <small class="badge bg-danger align-bottom ms-1">2</small></h6>
                </div>
                ...
                <div id="unassigned-task" class="tasks">
                    <div class="card tasks-box">
                        <div class="card-body">
                            <div class="d-flex mb-2">
                                <h6 class="fs-16 mb-0 flex-grow-1 text-truncate"><a href="apps-tasks-details" class="link-dark">Profile Page Structure</a></h6>
                                <div class="dropdown">
                    ...
                    <div class="card tasks-box">
                        <div class="card-body">
                            <div class="d-flex mb-2">
                                <div class="flex-grow-1">
                                    <h6 class="fs-16 mb-0 text-truncate"><a href="apps-tasks-details" class="link-dark">Velzon - Admin Layout Design</a></h6>
                                </div>
                                <div class="flex-shrink-0">
                ...
                <div id="todo-task" class="tasks">
                    <div class="card tasks-box">
                        <div class="card-body">
                            <div class="d-flex mb-2">
                                <div class="flex-grow-1">
                                    <h6 class="fs-16 mb-0 text-truncate"><a href="apps-tasks-details" class="link-dark">Admin Layout Design</a></h6>
                                </div>
                                <div class="flex-shrink-0">
                    ...
                    <div class="card tasks-box">
                        <div class="card-body">
                            <div class="d-flex mb-2">
                                <div class="flex-grow-1">
                                    <h6 class="fs-16 mb-0 text-truncate"><a href="apps-tasks-details" class="link-dark">Marketing & Sales</a></h6>
                                </div>
                                <div class="flex-shrink-0">
                ...
                <div id="inprogress-task" class="tasks">
                    <div class="card tasks-box">
                        <div class="card-body">
                            ...
                            <h6 class="fs-16 text-truncate"><a href="apps-tasks-details" class="link-dark">Brand Logo Design</a></h6>
                    ...
                    <div class="card tasks-box">
                        <div class="card-body">
                            ...
                            <h6 class="fs-16 text-truncate"><a href="apps-tasks-details" class="link-dark">Change Old App Icon</a></h6>
                ...
                <div id="reviews-task" class="tasks">
                    <div class="card tasks-box">
                        <div class="card-body">
                            ...
                            <h6 class="fs-16 text-truncate"><a href="apps-tasks-details" class="link-dark">Create Product Animations</a></h6>
                    ...
                    <div class="card tasks-box">
                        <div class="card-body">
                            ...
                            <h6 class="fs-16 text-truncate"><a href="apps-tasks-details" class="link-dark">Product Features Analysis</a></h6>
                    ...
                    <div class="card tasks-box">
                        <div class="card-body">
                            ...
                            <h6 class="fs-16 text-truncate"><a href="apps-tasks-details" class="link-dark">Create a Graph of Sketch</a></h6>
            ...
            <div data-simplebar class="tasks-wrapper px-3 mx-n3">
                <div id="completed-task" class="tasks">
                    <div class="card tasks-box">
                        <div class="card-body">
                            <div class="d-flex mb-2">
                                <h6 class="fs-16 mb-0 flex-grow-1 text-truncate"><a href="apps-tasks-details" class="link-dark">Create a Blog Template UI</a></h6>
                                <div class="dropdown">
                ...
                <div id="new-task" class="tasks">
                    <div class="card tasks-box">
                        <div class="card-body">
                            ...
                            <h6 class="fs-16 text-truncate"><a href="apps-tasks-details" class="link-dark">Banner Design for FB & Twitter</a></h6>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Application\Template\laravel_velzon-main\resources\views/apps-tasks-kanban.blade.php ENDPATH**/ ?>