                                ...
                                <div class="row g-3 mb-0 align-items-center">
                                    <div class="col-sm-auto">
                                        <div class="input-group">
                                            ...
                                            <div class="input-group-text bg-secondary border-secondary text-white"><i class="ri-calendar-2-line"></i></div>
                                        </div>
                                    </div><!--end col-->
                                    <div class="col-auto">
                            ...
                            <div class="flex-shrink-0">
                                <div class="dropdown card-header-dropdown">
                                    <a class="text-reset dropdown-btn" href="#" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                        <span class="fw-semibold text-uppercase fs-13">Sort by: </span><span class="text-muted">Today<i class="mdi mdi-chevron-down ms-1"></i></span>
                                    </a>
        ...
        <div class="layout-rightside">
            <div class="card h-100 rounded-0">
                <div class="card-body p-0">
                    <div class="p-3">
                        <h6 class="text-muted mb-0 text-uppercase fw-semibold fs-13">Recent Activity</h6>
                    </div>
                    ...
                    <div class="p-3 mt-2">
                        <h6 class="text-muted mb-3 text-uppercase fw-semibold fs-13">Top 10 Categories</h6>
                    ...
                    <div class="p-3">
                        <h6 class="text-muted mb-3 text-uppercase fw-semibold fs-13">Products Reviews</h6>
                        <!-- Swiper -->
                    ...
                    <div class="p-3">
                        <h6 class="text-muted mb-3 text-uppercase fw-semibold fs-13">Customer Reviews</h6>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Application\Template\laravel_velzon-main\resources\views/INDEX.blade.php ENDPATH**/ ?>